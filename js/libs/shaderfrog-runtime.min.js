var ShaderFrogRuntime = function (e)
{
	function r(t)
	{
		...
		var n = a[t] = {exports: {}, id: t, loaded: !1};
...
}([function (e, r, a)
{
	...
	function i()
	{
		var e = arguments.length, r = arguments[0];
		if (2 > e) return r;
		for (var a = 1; e > a; a++)
		{
	...
	function o(e)
	{
		var r = s(e), a = void 0, t = void 0;
		for (a = 0; t = arguments[a++ + 1];)
		{
			delete r[t];
		}
		return r
	...
	n.prototype = {
		...
		umap: {
			"float": {type: "f", value: 0}, "int": {type: "i", value: 0}, vec2: {
				type: "v2", value: function ()
				{
					return new THREE.Vector2
				}
			}, vec3: {
				type: "v3", value: function ()
				{
					return new THREE.Vector3
				}
			}, vec4: {
				type: "v4", value: function ()
				{
					return new THREE.Vector4
				}
			}, samplerCube: {type: "t"}, sampler2D: {type: "t"}
		},
		getUmap: function (e)
		{
		...
		load: function (e, r)
		{
			var a = this, t = e, n = "string" == typeof e;
			n && (t = [e]);
			for (var i = new Array(t.length), s = 0, o = function (e, o)
			{
				var u = new THREE.FileLoader();
				u.load(o, function (u)
				{
					var d = void 0;
					try
		...
		{
			//if (!(e instanceof THREE.Camera)) throw new Error("Cannot register a non-camera as a camera!");
			this.mainCamera = e
		},
		...
		{
			if (e in this.cubeCameras) delete this.cubeCameras[e]; else
			{
		...
		updateSource: function (e, r, a)
		{
			...
			var t = this.add(e, r), n = void 0, s = void 0;
			for (s = 0; n = this.runningShaders[s++];)
			{
				n[a] === e && (i(n.material, o(t, "id")), n.material.needsUpdate = !0)
			}
		},
		renameShader: function (e, r)
		{
			var a = void 0, t = void 0;
			if (!(e in this.shaderTypes)) throw new Error("Could not rename shader " + e + " to " + r + ". It does not exist.");
			for (this.shaderTypes[r] = this.shaderTypes[e], delete this.shaderTypes[e], a = 0; t = this.runningShaders[a++];)
			{
				t.name === e && (t.name = r)
			}
		},
		...
		add: function (e, r)
		{
			...
			{
				t = a.uniforms[n], null === t.value && (a.uniforms[n].value = this.getUmap(t.glslType));
			}
		...
		{
			var r = this.shaderTypes[e];
			return r.material = new THREE.RawShaderMaterial(r), this.runningShaders.push(r), r.init && r.init(r.material), r.material.needsUpdate = !0, r.initted = !0, r.material
		},
		updateRuntime: function (e, r, a)
		{
			a = a || "name";
			var t = void 0, n = void 0, i = void 0, s = void 0;
			for (n = 0; t = this.runningShaders[n++];)
			{
				if (t[a] === e) for (i in r.uniforms)
				{
					i in this.reserved || i in t.material.uniforms && (s = r.uniforms[i], "t" === s.type && "string" == typeof s.value && (s.value = this.cubeCameras[s.value].renderTarget), t.material.uniforms[i].value = r.uniforms[i].value)
				}
			}
		},
		updateShaders: function (e, r)
		{
			...
			for (r = r || {}, t = 0; a = this.runningShaders[t++];)
			{
				...
				{
					n in a.material.uniforms && (a.material.uniforms[n].value = r.uniforms[n]);
				}
